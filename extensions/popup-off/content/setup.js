...
const initMode = async () => {
	let { statsEnabled, restoreContActive, staticSubMode } = await getStorageData([
		"statsEnabled",
		"restoreContActive",
		"staticSubMode",
	]);
	...
	startMode({ curModeName: "hardModeActive", statsEnabled, shouldRestoreCont, staticSubMode });
};
